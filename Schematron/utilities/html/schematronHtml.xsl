...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:nem="https://www.nemsis.org">
  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <head>
        ...
        <link rel="stylesheet" type="text/css" href="https://www.nemsis.org/media/nemsis_v3/master/Schematron/utilities/html/schematronHtml.css" />

        <script type="text/javascript">
          
          var version = '<xsl:value-of select="sch:schema/@schemaVersion"/>'.split('.').slice(0, 3).join('.');
          var versionBase = 'https://www.nemsis.org/media/nemsis_v3/release-' + version;
  ...
  <xsl:variable name="nemsisElements">
    <nemsisElements>
      <DEMDataSet xmlns="https://www.nemsis.org" nemsisName="Root Tag For Demographic DataSet">
      ...
      <EMSDataSet xmlns="https://www.nemsis.org" nemsisName="EMS Agency Unique State ID">
...
>>>>>>> feature-SchematronDocumentationUpdate2017
</xsl:stylesheet>