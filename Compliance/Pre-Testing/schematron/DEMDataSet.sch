...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" queryBinding="xslt2" id="DEMDataSet" schemaVersion="3.5.0.191130CP1_compliance_pre_2021">

  <sch:title>NEMSIS ISO Schematron file for DEMDataSet for Compliance Pre-testing (2021, v3.5.0)</sch:title>
  ...
  <sch:pattern id="compliance_dContact">
    ...
    <sch:rule id="compliance_dContact_type" context="nem:dContact">
      ...
      <sch:assert id="compliance_dContact_type_director" role="[ERROR]" diagnostics="nemsisDiagnostic" test="nem:dContact.ContactInfoGroup/nem:dContact.01 = '1101003'">
        There should be an EMS Agency Director/Chief/Lead Administrator/CEO contact. This is a validation message for compliance pre-testing for 2021 for NEMSIS v3.5.0.
      </sch:assert>
    ...
    <sch:rule id="compliance_dContact.ContactInfoGroup" context="nem:dContact.ContactInfoGroup[nem:dContact.01='1101003']">
      ...
      <sch:assert id="compliance_dAgency.ContactInfoGroup_website" role="[WARNING]" diagnostics="nemsisDiagnostic" test="nem:dContact.12[.!='']">
        The EMS Agency Contact Web Address should be recorded for the EMS Agency Director/Chief/Lead Administrator/CEO contact (<sch:value-of select="nem:dContact.03"/> <sch:value-of select="nem:dContact.02"/>). This is a validation message for compliance pre-testing for 2021 for NEMSIS v3.5.0.
      </sch:assert>
