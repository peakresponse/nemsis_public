<?xml version="1.0" encoding="UTF-8"?><?xml-stylesheet type="text/xsl" href="../utilities/html/schematronHtml.xsl"?><sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" queryBinding="xslt2" id="EMSDataSet" schemaVersion="3.4.0.200320" see="https://nemsis.org/technical-resources/version-3/version-3-schematron/">
  ...
  <sch:rule id="nemSch_consistency_eArrest_all_eArrest.02" context="nem:eArrest.02[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eArrest_all_present_eArrest.02" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="not(../nem:eArrest.01 = ('3001003', '3001005'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest_all_eArrest.03" context="nem:eArrest.03[1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.03"/>

    <sch:assert id="nemSch_consistency_eArrest_all_present_eArrest.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.03 != '' or not(../nem:eArrest.01 = ('3001003', '3001005'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest_all_eArrest.04" context="nem:eArrest.04[. = ''][1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.04[. = '']"/>

    <sch:assert id="nemSch_consistency_eArrest_all_present_eArrest.04" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.04 != '' or not(../nem:eArrest.01 = ('3001003', '3001005'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest_all_eArrest.05" context="nem:eArrest.05[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eArrest_all_present_eArrest.05" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="not(../nem:eArrest.01 = '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes, Prior to EMS Arrival".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest_all_eArrest.07" context="nem:eArrest.07[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eArrest_all_present_eArrest.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="not(../nem:eArrest.01 = '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes, Prior to EMS Arrival".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest_all_eArrest.17" context="nem:eArrest.17[. = ''][1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.17"/>

    <sch:assert id="nemSch_consistency_eArrest_all_present_eArrest.17" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01, ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="../nem:eArrest.17 != '' or not(../nem:eArrest.01 = ('3001003', '3001005') and ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient Dead at Scene... (with Transport)" or "Patient Treated, Transported by this EMS Unit" and <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.02" context="nem:eArrest.02[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.02" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
  ...
  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.03" context="nem:eArrest.03[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.03[. != '']"/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.04" context="nem:eArrest.04[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.04[. != '']"/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.04" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.05" context="nem:eArrest.05[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.05" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.07" context="nem:eArrest.07[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.07[. != '']"/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.09" context="nem:eArrest.09[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.09[. != '']"/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.09" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.12" context="nem:eArrest.12[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.12[. != '']"/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.12" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.14" context="nem:eArrest.14[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.14" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.16" context="nem:eArrest.16[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.16" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.17" context="nem:eArrest.17[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.17[. != '']"/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.17" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eArrest.01_eArrest.18" context="nem:eArrest.18[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eArrest.01_yes_eArrest.18" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.01" test="../nem:eArrest.01 = ('3001003', '3001005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eArrest.01', $nemSch_elements)"/> is "Yes...".
    </sch:assert>
  ...
  <sch:rule id="nemSch_consistency_eArrest.03_attempted" context="nem:eArrest.03[1]">
    ...
    <sch:assert id="nemSch_consistency_eArrest.03_attempted_not" role="[WARNING]" diagnostics="nemsisDiagnostic" test="not(../nem:eArrest.03 = ('3003001', '3003003', '3003005') and ../nem:eArrest.03 = ('3003007', '3003009', '3003011'))">
      <sch:value-of select="key('nemSch_key_elements', 'eArrest.03', $nemSch_elements)"/> should not contain both "Attempted/Initiated..." and "Not Attempted...".
    </sch:assert>
  ...
  <sch:rule id="nemSch_consistency_eArrest.03_eArrest.09_match_eArrest.03" context="nem:eArrest.03[1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.03"/>

    <sch:assert id="nemSch_consistency_eArrest.03_eArrest.09_compressions_2" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.09" test="../nem:eArrest.03 = '3003005' or not(../nem:eArrest.09 = ('3009001', '3009003', '3009005', '3009007', '3009009', '3009011', '3009021'))">
    ...
    <sch:assert id="nemSch_consistency_eArrest.03_eArrest.09_ventilation_2" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.09" test="../nem:eArrest.03 = '3003003' or not(../nem:eArrest.09 = ('3009009', '3009013', '3009015', '3009017', '3009019', '3009023', '3009025', '3009027'))">
  ...
  <sch:rule id="nemSch_consistency_eArrest.03_eArrest.09_match_eArrest.09" context="nem:eArrest.09[1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.09"/>

    <sch:assert id="nemSch_consistency_eArrest.03_eArrest.09_compressions_1" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.03" test="not(../nem:eArrest.03 = '3003005') or ../nem:eArrest.09 = ('3009001', '3009003', '3009005', '3009007', '3009009', '3009011', '3009021')">
    ...
    <sch:assert id="nemSch_consistency_eArrest.03_eArrest.09_ventilation_1" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eArrest.03" test="not(../nem:eArrest.03 = '3003003') or ../nem:eArrest.09 = ('3009009', '3009013', '3009015', '3009017', '3009019', '3009023', '3009025', '3009027')">
  ...
  <sch:rule id="nemSch_consistency_eDisposition.06" context="nem:eDisposition.06[. != '']">
    ...
    <sch:assert id="nemSch_consistency_eDisposition.06_eDisposition.05" role="[WARNING]" subject="., ../nem:eDisposition.05" diagnostics="nemsisDiagnostic" test="starts-with(., ../nem:eDisposition.05)">
  ...
  <sch:rule id="nemSch_consistency_eDisposition.21_hospital_rule1" context="nem:eDisposition.22[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.21_hospital_eDisposition.22" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eDisposition.21" test="not(../nem:eDisposition.21 = '4221005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.21', $nemSch_elements)"/> is "Hospital-Non-Emergency Department Bed".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.21_hospital_rule2" context="nem:eDisposition.23[. = ''][1]">

    <sch:let name="nemsisElements" value="../nem:eDisposition.23"/>

    <sch:assert id="nemSch_consistency_eDisposition.21_hospital_eDisposition.23_cardiacarrest" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eDisposition.21, ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.01" test="../nem:eDisposition.23 != '' or not(../nem:eDisposition.21 = ('4221003', '4221005', '4221023') and ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.01 = ('3001003', '3001005'))">
    ...
    <sch:assert id="nemSch_consistency_eDisposition.21_hospital_eDisposition.23_stroke" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eDisposition.21, ancestor::nem:PatientCareReport/nem:eVitals/nem:eVitals.VitalGroup/nem:eVitals.StrokeScaleGroup/nem:eVitals.29" test="../nem:eDisposition.23 != '' or not(../nem:eDisposition.21 = ('4221003', '4221005', '4221023') and ancestor::nem:PatientCareReport/nem:eVitals/nem:eVitals.VitalGroup/nem:eVitals.StrokeScaleGroup/nem:eVitals.29 = '3329005')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.21', $nemSch_elements)"/> is "Hospital..." or "Freestanding Emergency Department" and <sch:value-of select="key('nemSch_key_elements', 'eVitals.29', $nemSch_elements)"/> is "Positive".
    </sch:assert>

    <sch:assert id="nemSch_consistency_eDisposition.21_hospital_eDisposition.23_stemi" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eDisposition.21, ancestor::nem:PatientCareReport/nem:eVitals/nem:eVitals.VitalGroup/nem:eVitals.CardiacRhythmGroup/nem:eVitals.03" test="../nem:eDisposition.23 != '' or not(../nem:eDisposition.21 = ('4221003', '4221005', '4221023') and ancestor::nem:PatientCareReport/nem:eVitals/nem:eVitals.VitalGroup/nem:eVitals.CardiacRhythmGroup/nem:eVitals.03 = ('9901051', '9901053', '9901055', '9901057', '9901058'))">
  ...
  <sch:rule id="nemSch_consistency_eDisposition.12_all_eTimes.05" context="nem:eTimes.05[. = '']">
    
    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eTimes.05" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = '4212007'">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded unless <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Canceled (Prior to Arrival At Scene)".
    </sch:assert>
    
  </sch:rule>
  
  <sch:rule id="nemSch_consistency_eDisposition.12_all_eTimes.06" context="nem:eTimes.06[. = '']">
    
    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eTimes.06" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = '4212007'">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded unless <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Canceled (Prior to Arrival At Scene)".
    </sch:assert>
    
  </sch:rule>
  
  <sch:rule id="nemSch_consistency_eDisposition.12_all_eTimes.07" context="nem:eTimes.07[. = '']">
    
    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eTimes.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212015', '4212017', '4212019', '4212021', '4212023', '4212025', '4212027', '4212029', '4212031', '4212033', '4212035', '4212037'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient...".
    </sch:assert>
    
  </sch:rule>
  
  <sch:rule id="nemSch_consistency_eDisposition.12_all_eTimes.09" context="nem:eTimes.09[. = '']">
    
    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eTimes.09" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>
    
  </sch:rule>
  
  <sch:rule id="nemSch_consistency_eDisposition.12_all_eTimes.11" context="nem:eTimes.11[. = '']">
    
    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eTimes.11" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>
    
  </sch:rule>
  
  <sch:rule id="nemSch_consistency_eDisposition.12_all_eTimes.12" context="nem:eTimes.12[. = '']">
    
    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eTimes.12" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>
    
  </sch:rule>
  
  <sch:rule id="nemSch_consistency_eDisposition.12_all_ePatient.07" context="nem:ePatient.07[. = '']">
    
    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_ePatient.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>
    
  </sch:rule>
  
  <sch:rule id="nemSch_consistency_eDisposition.12_all_ePatient.08" context="nem:ePatient.08[. = '']">
    
    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_ePatient.08" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>
    
  </sch:rule>
  
  <sch:rule id="nemSch_consistency_eDisposition.12_all_ePatient.09" context="nem:ePatient.09[. = '']">
    
    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_ePatient.09" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>
    
  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_ePatient.13" context="nem:ePatient.13[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_ePatient.13" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212015', '4212017', '4212019', '4212021', '4212023', '4212025', '4212027', '4212029', '4212031', '4212033', '4212035', '4212037'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_ePatient.14" context="nem:ePatient.14[. = '']">

    <sch:let name="nemsisElements" value="../nem:ePatient.14"/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_ePatient.14" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="../nem:ePatient.14 != '' or not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_ePatient.15" context="nem:ePatient.15[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_ePatient.15" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212015', '4212017', '4212019', '4212021', '4212023', '4212025', '4212027', '4212029', '4212031', '4212033', '4212035', '4212037'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_ePatient.16" context="nem:ePatient.16[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_ePatient.16" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212015', '4212017', '4212019', '4212021', '4212023', '4212025', '4212027', '4212029', '4212031', '4212033', '4212035', '4212037'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient...".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_ePayment.01" context="nem:ePayment.01[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_ePayment.01" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eScene.09" context="nem:eScene.09[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eScene.09" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = '4212007'">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded unless <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Canceled (Prior to Arrival At Scene)".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eSituation.02" context="nem:eSituation.02[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eSituation.02" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05, ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05 = '2205001' and ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = '4212033')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when Type of Service Requested is "911 Response (Scene)" and <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eSituation.07" context="nem:eSituation.07[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eSituation.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05, ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05 = '2205001' and ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = '4212033')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when Type of Service Requested is "911 Response (Scene)" and <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eSituation.08" context="nem:eSituation.08[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eSituation.08" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05, ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05 = '2205001' and ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = '4212033')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when Type of Service Requested is "911 Response (Scene)" and <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eSituation.09" context="nem:eSituation.09[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eSituation.09" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05, ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05 = '2205001' and ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = '4212033')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when Type of Service Requested is "911 Response (Scene)" and <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eSituation.11" context="nem:eSituation.11[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eSituation.11" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05, ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05 = '2205001' and ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = '4212033')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when Type of Service Requested is "911 Response (Scene)" and <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eSituation.13" context="nem:eSituation.13[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eSituation.13" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05, ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eResponse/nem:eResponse.ServiceGroup/nem:eResponse.05 = '2205001' and ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = '4212033')">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when Type of Service Requested is "911 Response (Scene)" and <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eArrest.16" context="nem:eArrest.16[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eArrest.16" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212017', '4212019'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient Dead at Scene-Resuscitation Attempted..."
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eDisposition.05" context="nem:eDisposition.05[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eDisposition.05" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eDisposition.06" context="nem:eDisposition.06[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eDisposition.06" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eDisposition.07" context="nem:eDisposition.07[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eDisposition.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eDisposition.16" context="nem:eDisposition.16[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eDisposition.16" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eDisposition.17" context="nem:eDisposition.17[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eDisposition.17" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eDisposition.19" context="nem:eDisposition.19[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eDisposition.19" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eDisposition.20" context="nem:eDisposition.20[. = ''][1]">

    <sch:let name="nemsisElements" value="../nem:eDisposition.20"/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eDisposition.20" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="../nem:eDisposition.20 != '' or not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eDisposition.12_all_eDisposition.21" context="nem:eDisposition.21[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eDisposition.12_all_warning_eDisposition.21" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="not(ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212017', '4212023', '4212033'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "... (With Transport)" or "Patient Treated, Transported by this EMS Unit".
    </sch:assert>
  ...
  <sch:rule id="nemSch_consistency_eDisposition.HospitalTeamActivationGroup_nonempty" context="nem:eDisposition.HospitalTeamActivationGroup[* != '']">
    ...
    <sch:assert id="nemSch_consistency_eDisposition.HospitalTeamActivationGroup_eDisposition.25_present" role="[WARNING]" diagnostics="nemsisDiagnostic" test="nem:eDisposition.25 != '' or nem:eDisposition.24 = '4224001'">
  ...
  <sch:rule id="nemSch_consistency_eInjury_all" context="nem:eInjury.01[. = ''][1]">

    <sch:let name="nemsisElements" value="../nem:eInjury.01"/>

    <sch:assert id="nemSch_consistency_eInjury_all_present_eInjury.01" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.02, ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12" test="../nem:eInjury.01 != '' or not(ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.02 = '9922005' and ancestor::nem:PatientCareReport/nem:eDisposition/nem:eDisposition.12 = ('4212013', '4212015', '4212017', '4212019', '4212021', '4212023', '4212025', '4212027', '4212029', '4212031', '4212033', '4212035', '4212037'))">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', 'eDisposition.12', $nemSch_elements)"/> is "Patient..." and <sch:value-of select="key('nemSch_key_elements', 'eSituation.02', $nemSch_elements)"/> is "Yes".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eInjury_eSituation.02_eInjury.01" context="nem:eInjury.01[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eInjury.01[. != '']"/>

    <sch:assert id="nemSch_consistency_eInjury_eSituation.02_yes_eInjury.01" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.02" test="ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.02 = '9922005'">
  ...
  <sch:rule id="nemSch_consistency_eInjury_eSituation.02_eInjury.03" context="nem:eInjury.03[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eInjury.03[. != '']"/>

    <sch:assert id="nemSch_consistency_eInjury_eSituation.02_yes_eInjury.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.02" test="ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.02 = '9922005'">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eSituation.02', $nemSch_elements)"/> is "Yes".
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eInjury_eSituation.02_eInjury.04" context="nem:eInjury.04[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eInjury.04[. != '']"/>

    <sch:assert id="nemSch_consistency_eInjury_eSituation.02_yes_eInjury.04" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.02" test="ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.02 = '9922005'">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should only be recorded when <sch:value-of select="key('nemSch_key_elements', 'eSituation.02', $nemSch_elements)"/> is "Yes".
    </sch:assert>
  ...
  <sch:rule id="nemSch_consistency_ePatient.07" context="nem:ePatient.07[. != '']">
    ...
    <sch:assert id="nemSch_consistency_ePatient.07_ePatient.08" role="[WARNING]" subject="., ../nem:ePatient.08" diagnostics="nemsisDiagnostic" test="starts-with(., ../nem:ePatient.08)">
  ...
  <sch:rule id="nemSch_consistency_ePatient.15" context="nem:ePatient.16[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_ePatient.15_ePatient.16" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="../nem:ePatient.15, ." test="../nem:ePatient.15 = ''">
  ...
  <sch:rule id="nemSch_consistency_eScene.07_mci_rule1" context="nem:eScene.06">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eScene.07_mci_eScene.06" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eScene.07" test=". = '2707001' or ../nem:eScene.07 != '9923003'">
  ...
  <sch:rule id="nemSch_consistency_eScene.07_mci_rule2" context="nem:eScene.08[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eScene.07_mci_eScene.08" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eScene.07" test="../nem:eScene.07 != '9923003'">
  ...
  <sch:rule id="nemSch_consistency_eScene.21" context="nem:eScene.21[. != '']">
    ...
    <sch:assert id="nemSch_consistency_eScene.21_eScene.18" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eScene.18" test="starts-with(., ../nem:eScene.18)">
  ...
  <sch:rule id="nemSch_consistency_eSituation.09" context="nem:eSituation.10[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eSituation.10[. != '']"/>

    <sch:assert id="nemSch_consistency_eSituation.09_eSituation.10" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eSituation.09" test="../nem:eSituation.09 != ''">
  ...
  <sch:rule id="nemSch_consistency_eSituation.11" context="nem:eSituation.12[. != ''][1]">

    <sch:let name="nemsisElements" value="../nem:eSituation.12[. != '']"/>

    <sch:assert id="nemSch_consistency_eSituation.11_eSituation.12" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eSituation.11" test="../nem:eSituation.11 != ''">
  ...
  <sch:rule id="nemSch_consistency_eSituation_injury" context="nem:eSituation.02">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eSituation_injury_eSituation.02" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../(nem:eSituation.09, nem:eSituation.10, nem:eSituation.11, nem:eSituation.12)" test=". = '9922005' or not(some $element in ../(nem:eSituation.09, nem:eSituation.10, nem:eSituation.11, nem:eSituation.12) satisfies matches($element, '^(S|T(0\d|1[0-4]))'))">
      <sch:value-of select="key('nemSch_key_elements', 'eSituation.02', $nemSch_elements)"/> should be "Yes" when a symptom or impression is injury-related.
    </sch:assert>
  ...
  <sch:rule id="nemSch_consistency_eMedications.MedicationGroup_eMedications.01" context="nem:eMedications.MedicationGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eMedications.01[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eMedications.MedicationGroup_all_eMedications.01" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eMedications.02" test="../nem:eMedications.02 = '9923003'">
  ...
  <sch:rule id="nemSch_consistency_eMedications.MedicationGroup_eMedications.03" context="nem:eMedications.MedicationGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eMedications.03[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eMedications.MedicationGroup_all_eMedications.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="." test="false()">
  ...
  <sch:rule id="nemSch_consistency_eProcedures.ProcedureGroup_eProcedures.01" context="nem:eProcedures.ProcedureGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eProcedures.01[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eProcedures.ProcedureGroup_all_eProcedures.01" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eProcedures.02" test="../nem:eProcedures.02 = '9923003'">
  ...
  <sch:rule id="nemSch_consistency_eProcedures.ProcedureGroup_eProcedures.03" context="nem:eProcedures.ProcedureGroup[some $element in .//* satisfies normalize-space($element) != '' and not($element/@PN)]/nem:eProcedures.03[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eProcedures.ProcedureGroup_all_eProcedures.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="." test="false()">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should be recorded when a procedure is performed.
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eVitals.VitalGroup" context="nem:eVitals.VitalGroup[some $element in .//* satisfies normalize-space($element) != '']/nem:eVitals.01[. = '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eVitals.VitalGroup_all_eVitals.01" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="., ../nem:eVitals.02" test="../nem:eVitals.02 = '9923003'">
  ...
  <sch:rule id="nemSch_consistency_eMedications.DosageGroup" context="nem:eMedications.05[. != '']">
    ...
    <sch:assert id="nemSch_consistency_eMedications.DosageGroup_eMedications.06" role="[WARNING]" diagnostics="nemsisDiagnostic" test="../nem:eMedications.06 != ''">
      <sch:value-of select="key('nemSch_key_elements', 'eMedications.06', $nemSch_elements)"/> should be recorded when <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> is recorded.
    </sch:assert>

  </sch:rule>

</sch:pattern><?DSDL_INCLUDE_END includes/pattern_consistency_group.xml?>
  <?DSDL_INCLUDE_START includes/pattern_consistency_eNilNvPn.xml?><sch:pattern id="nemSch_consistency_eNilNvPn">

  <!-- This pattern allows the following combinations of nil, NV, and PN attributes:
         * For eCustomResults.01: Any combination
       ...
       than the rule for eCustomResults that will never generated a failed assert).
  ...
  <sch:rule id="nemSch_consistency_eNilNvPn_customResults" context="nem:eCustomResults.01">

    <!-- This rule fires when eCustomResults.01 Custom Data Element Result has a Pertinent 
  ...
  <sch:rule id="nemSch_consistency_eNilNvPn_eExam.AssessmentGroup" context="nem:eExam.AssessmentGroup//*[@PN]">
  ...
  <sch:rule id="nemSch_consistency_eNilNvPn_Pn_medication" context="nem:eMedications.03[@PN]">

    <!-- This rule fires when eMedications.03 Medication Given has a Pertinent Negative attribute. -->

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eNilNvPn_Pn_Not_NilNv_eMedications.03" role="[ERROR]" diagnostics="nemsisDiagnostic" test="not(@NV) and not(@xsi:nil = 'true')">
  ...
  <sch:rule id="nemSch_consistency_eNilNvPn_Pn_procedure" context="nem:eProcedures.03[@PN]">

    <!-- This rule fires when eProcedures.03 Procedure Given has a Pertinent Negative attribute. -->

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_consistency_eNilNvPn_Pn_Not_NilNv_eProcedures.03" role="[ERROR]" diagnostics="nemsisDiagnostic" test="not(@NV) and not(@xsi:nil = 'true')">
      When <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> has a Pertinent Negative, it should have a value and it should not have a Not Value (Not Applicable, Not Recorded, or Not Reporting).
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_consistency_eNilNvPn_Pn" context="*[@PN]">
    ...
    <sch:assert id="nemSch_consistency_eNilNvPn_Pn_Nv_Not_Nil" role="[ERROR]" diagnostics="nemsisDiagnostic" test="not(@NV) and @xsi:nil = 'true'">
  ...
  <sch:rule id="nemSch_consistency_eNilNvPn_Nil" context="*[@xsi:nil = 'true']">
    ...
    <sch:assert id="nemSch_consistency_eNilNvPn_Nil_Nv" role="[ERROR]" diagnostics="nemsisDiagnostic" test="@NV">
  ...
  <sch:rule id="nemSch_consistency_eNilNvPn_Nv" context="*[@NV]">
    ...
    <sch:assert id="nemSch_consistency_eNilNvPn_Nv_Nil" role="[ERROR]" diagnostics="nemsisDiagnostic" test="@xsi:nil='true'">
...
</sch:pattern><?DSDL_INCLUDE_END includes/pattern_consistency_eNilNvPn.xml?>
  ...
  <sch:rule id="nemSch_sequence_time_eTimes_order_eTimes.03" context="nem:eTimes.03[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.03_eTimes.01" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.01, ." test="../nem:eTimes.01 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.01)">
  ...
  <sch:rule id="nemSch_sequence_time_eTimes_order_eTimes.05" context="nem:eTimes.05[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.05_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.03, ." test="xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.03)">
  ...
  <sch:rule id="nemSch_sequence_time_eTimes_order_eTimes.06" context="nem:eTimes.06[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.06_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.03, ." test="xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.03)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.03', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.06_eTimes.05" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.05, ." test="../nem:eTimes.05 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.05)">
  ...
  <sch:rule id="nemSch_sequence_time_eTimes_order_eTimes.07" context="nem:eTimes.07[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.07_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.03, ." test="xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.03)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.03', $nemSch_elements)"/>.
    </sch:assert>
  ...
  <sch:rule id="nemSch_sequence_time_eTimes_order_eTimes.09" context="nem:eTimes.09[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.09_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.03, ." test="xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.03)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.03', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.09_eTimes.05" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.05, ." test="../nem:eTimes.05 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.05)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.05', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.09_eTimes.06" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.06, ." test="../nem:eTimes.06 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.06)">
    ...
    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.09_eTimes.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.07, ." test="../nem:eTimes.07 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.07)">
  ...
  <sch:rule id="nemSch_sequence_time_eTimes_order_eTimes.11" context="nem:eTimes.11[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.11_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.03, ." test="xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.03)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.03', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.11_eTimes.05" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.05, ." test="../nem:eTimes.05 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.05)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.05', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.11_eTimes.06" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.06, ." test="../nem:eTimes.06 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.06)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.06', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.11_eTimes.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.07, ." test="../nem:eTimes.07 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.07)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.07', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.11_eTimes.09" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.09, ." test="../nem:eTimes.09 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.09)">
  ...
  <sch:rule id="nemSch_sequence_time_eTimes_order_eTimes.12" context="nem:eTimes.12[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.12_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.03, ." test="xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.03)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.03', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.12_eTimes.05" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.05, ." test="../nem:eTimes.05 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.05)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.05', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.12_eTimes.06" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.06, ." test="../nem:eTimes.06 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.06)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.06', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.12_eTimes.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.07, ." test="../nem:eTimes.07 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.07)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.07', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.12_eTimes.09" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.09, ." test="../nem:eTimes.09 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.09)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.09', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.12_eTimes.11" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.11, ." test="../nem:eTimes.11 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.11)">
    ...
    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.12_eSituation.01" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.01, ." test="ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.01 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.01)">
    ...
    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.12_eArrest.14" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.14, ." test="ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.14 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.14)">
  ...
  <sch:rule id="nemSch_sequence_time_eTimes_order_eTimes.13" context="nem:eTimes.13[. != '']">

    <sch:let name="nemsisElements" value="."/>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.13_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.03, ." test="xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.03)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.03', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.13_eTimes.05" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.05, ." test="../nem:eTimes.05 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.05)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.05', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.13_eTimes.06" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.06, ." test="../nem:eTimes.06 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.06)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.06', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.13_eTimes.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.07, ." test="../nem:eTimes.07 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.07)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.07', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.13_eTimes.09" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.09, ." test="../nem:eTimes.09 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.09)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.09', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.13_eTimes.11" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.11, ." test="../nem:eTimes.11 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.11)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.11', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.13_eTimes.12" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="nem:eTimes.12, ." test="../nem:eTimes.12 = '' or xs:dateTime(.) &gt;= xs:dateTime(../nem:eTimes.12)">
    ...
    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.13_eSituation.01" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.01, ." test="ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.01 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eSituation/nem:eSituation.01)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eSituation.01', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_order_eTimes.13_eArrest.14" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.14, ." test="ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.14 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eArrest/nem:eArrest.14)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eArrest.14', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eTimes_current_eTimes.13" role="[WARNING]" diagnostics="nemsisDiagnostic" test="xs:dateTime(.) &lt;= current-dateTime() + xs:dayTimeDuration('PT1H')">
  ...
  <sch:rule id="nemSch_sequence_time_eDisposition.25" context="nem:eDisposition.25[. != '']">
    ...
    <sch:assert id="nemSch_sequence_time_eDisposition.25_after_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03, ." test="xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be earlier than <sch:value-of select="key('nemSch_key_elements', 'eTimes.03', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eDisposition.25_before_eTimes.12" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12, ." test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12 = '' or xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12)">
    ...
    <sch:assert id="nemSch_sequence_time_eDisposition.25_before_eTimes.13" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.13, ." test="xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.13)">
  ...
  <sch:rule id="nemSch_sequence_time_eMedications.01" context="nem:eMedications.01[. != '']">
    ...
    <sch:assert id="nemSch_sequence_time_eMedications.01_after_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03, ., ../nem:eMedications.02" test="xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03) or ../nem:eMedications.02 = '9923003'">
    ...
    <sch:assert id="nemSch_sequence_time_eMedications.01_prior_before_eTimes.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07, ., ../nem:eMedications.02" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07 = '' or xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07) or ../nem:eMedications.02 != '9923003'">
    ...
    <sch:assert id="nemSch_sequence_time_eMedications.01_before_eTimes.12" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12, ., ../nem:eMedications.02" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12 = '' or xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be later than <sch:value-of select="key('nemSch_key_elements', 'eTimes.12', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eMedications.01_before_eTimes.13" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.13, ., ../nem:eMedications.02" test="xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.13)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be later than <sch:value-of select="key('nemSch_key_elements', 'eTimes.13', $nemSch_elements)"/>.
    </sch:assert>
  ...
  <sch:rule id="nemSch_sequence_time_eProcedures.01" context="nem:eProcedures.01[. != '']">
    ...
    <sch:assert id="nemSch_sequence_time_eProcedures.01_after_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03, ., ../nem:eProcedures.02" test="xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03) or ../nem:eProcedures.02 = '9923003'">
    ...
    <sch:assert id="nemSch_sequence_time_eProcedures.01_after_eTimes.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07, ., ../nem:eProcedures.02" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07) or ../nem:eProcedures.02 = '9923003'">
    ...
    <sch:assert id="nemSch_sequence_time_eProcedures.01_prior_before_eTimes.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07, ., ../nem:eProcedures.02" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07 = '' or xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07) or ../nem:eProcedures.02 != '9923003'">
    ...
    <sch:assert id="nemSch_sequence_time_eProcedures.01_before_eTimes.12" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12, ., ../nem:eProcedures.02" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12 = '' or xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be later than <sch:value-of select="key('nemSch_key_elements', 'eTimes.12', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eProcedures.01_before_eTimes.13" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.13, ., ../nem:eProcedures.02" test="xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.13)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be later than <sch:value-of select="key('nemSch_key_elements', 'eTimes.13', $nemSch_elements)"/>.
    </sch:assert>
  ...
  <sch:rule id="nemSch_sequence_time_eVitals.01" context="nem:eVitals.01[. != '']">
    ...
    <sch:assert id="nemSch_sequence_time_eVitals.01_after_eTimes.03" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03, ., ../nem:eVitals.02" test="xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.03) or ../nem:eVitals.02 = '9923003'">
    ...
    <sch:assert id="nemSch_sequence_time_eVitals.01_after_eTimes.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07, ., ../nem:eVitals.02" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07 = '' or xs:dateTime(.) &gt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07) or ../nem:eVitals.02 = '9923003'">
    ...
    <sch:assert id="nemSch_sequence_time_eVitals.01_prior_before_eTimes.07" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07, ., ../nem:eVitals.02" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07 = '' or xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.07) or ../nem:eVitals.02 != '9923003'">
    ...
    <sch:assert id="nemSch_sequence_time_eVitals.01_before_eTimes.12" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12, ., ../nem:eVitals.02" test="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12 = '' or xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.12)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be later than <sch:value-of select="key('nemSch_key_elements', 'eTimes.12', $nemSch_elements)"/>.
    </sch:assert>

    <sch:assert id="nemSch_sequence_time_eVitals.01_before_eTimes.13" role="[WARNING]" diagnostics="nemsisDiagnostic" subject="ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.13, ., ../nem:eVitals.02" test="xs:dateTime(.) &lt;= xs:dateTime(ancestor::nem:PatientCareReport/nem:eTimes/nem:eTimes.13)">
      <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> should not be later than <sch:value-of select="key('nemSch_key_elements', 'eTimes.13', $nemSch_elements)"/>.
    </sch:assert>
  ...
  <sch:rule id="nemSch_uniqueness_EMSDataSet_eArrest.04" context="nem:eArrest.04[. = '3004001'][1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.04"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eArrest.04" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eArrest.04) = 1">
  ...
  <sch:rule id="nemSch_uniqueness_EMSDataSet_eArrest.12" context="nem:eArrest.12[. = '3012001'][1]">

    <sch:let name="nemsisElements" value="../nem:eArrest.12"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eArrest.12" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eArrest.12) = 1">
      When <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> is "No", no other value should be recorded.
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_uniqueness_EMSDataSet_eHistory.01" context="nem:eHistory.01[. = '3101009'][1]">

    <sch:let name="nemsisElements" value="../nem:eHistory.01"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eHistory.01" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eHistory.01) = 1">
  ...
  <sch:rule id="nemSch_uniqueness_EMSDataSet_eMedications.08" context="nem:eMedications.08[. = '3708031'][1]">

    <sch:let name="nemsisElements" value="../nem:eMedications.08"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eMedications.08" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eMedications.08) = 1">
      When <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> is "None", no other value should be recorded.
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_uniqueness_EMSDataSet_eProcedures.07" context="nem:eProcedures.07[. = '3907033'][1]">

    <sch:let name="nemsisElements" value="../nem:eProcedures.07"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eProcedures.07" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eProcedures.07) = 1">
      When <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> is "None", no other value should be recorded.
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_uniqueness_EMSDataSet_eResponse.08" context="nem:eResponse.08[. = '2208013'][1]">

    <sch:let name="nemsisElements" value="../nem:eResponse.08"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eResponse.08" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eResponse.08) = 1">
  ...
  <sch:rule id="nemSch_uniqueness_EMSDataSet_eResponse.09" context="nem:eResponse.09[. = '2209011'][1]">

    <sch:let name="nemsisElements" value="../nem:eResponse.09"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eResponse.09" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eResponse.09) = 1">
      When <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> is "None/No Delay", no other value should be recorded.
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_uniqueness_EMSDataSet_eResponse.10" context="nem:eResponse.10[. = '2210017'][1]">

    <sch:let name="nemsisElements" value="../nem:eResponse.10"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eResponse.10" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eResponse.10) = 1">
      When <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> is "None/No Delay", no other value should be recorded.
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_uniqueness_EMSDataSet_eResponse.11" context="nem:eResponse.11[. = '2211011'][1]">

    <sch:let name="nemsisElements" value="../nem:eResponse.11"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eResponse.11" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eResponse.11) = 1">
      When <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> is "None/No Delay", no other value should be recorded.
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_uniqueness_EMSDataSet_eResponse.12" context="nem:eResponse.12[. = '2212015'][1]">

    <sch:let name="nemsisElements" value="../nem:eResponse.12"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eResponse.12" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eResponse.12) = 1">
      When <sch:value-of select="key('nemSch_key_elements', local-name(), $nemSch_elements)"/> is "None/No Delay", no other value should be recorded.
    </sch:assert>

  </sch:rule>

  <sch:rule id="nemSch_uniqueness_EMSDataSet_eVitals.22" context="nem:eVitals.22[. = '3322003'][1]">

    <sch:let name="nemsisElements" value="../nem:eVitals.22"/>

    <sch:assert id="nemSch_uniqueness_EMSDataSet_none_eVitals.22" role="[WARNING]" diagnostics="nemsisDiagnostic" test="count(../nem:eVitals.22) = 1">
  ...
  <?DSDL_INCLUDE_START includes/pattern_uniqueness_eNvPn.xml?><sch:pattern id="nemSch_uniqueness_eNvPn">
  ...
  <sch:rule id="nemSch_uniqueness_eNvPn_eCustomResults" context="nem:eCustomResults.01">
  ...
  <sch:rule id="nemSch_uniqueness_eNvPn_eExam.AssessmentGroup" context="nem:eExam.AssessmentGroup//*[@PN]">
  ...
  <sch:rule id="nemSch_uniqueness_eNvPn_Nv" context="*[@NV][local-name() = (local-name(preceding-sibling::*[1]), local-name(following-sibling::*[1]))]">
    ...
    <sch:assert id="nemSch_uniqueness_eNvPn_Nv_only" role="[WARNING]" diagnostics="nemsisDiagnostic" test="false()">
  ...
  <sch:rule id="nemSch_uniqueness_eNvPn_Pn" context="*[@PN][local-name() = (local-name(preceding-sibling::*[1]), local-name(following-sibling::*[1]))]">
    ...
    <sch:assert id="nemSch_uniqueness_eNvPn_Pn_only" role="[WARNING]" diagnostics="nemsisDiagnostic" test="false()">
...
</sch:pattern><?DSDL_INCLUDE_END includes/pattern_uniqueness_eNvPn.xml?>
