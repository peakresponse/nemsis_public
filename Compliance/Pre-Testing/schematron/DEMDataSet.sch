...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
   ...
   <sch:title>NEMSIS ISO Schematron file for DEMDataSet for Compliance Pre-testing (2025, v3.5.0)</sch:title>
   ...
   <sch:pattern id="compliance_capability_protocol">
      ...
      EMS Agency Protocols should include "General-Community Paramedicine / Mobile Integrated Healthcare" when EMS Agency Specialty Service Capability includes "Community Health Medicine". This is a validation message for compliance pre-testing for 2025 for NEMSIS v3.5.0.
      </sch:assert>
      </sch:rule>
   </sch:pattern>
   <sch:pattern id="compliance_certification_dates">
      ...
      <sch:rule id="compliance_certification_dates_rule" context="nem:dPersonnel.25">
        ...
        EMS Personnel's State EMS Current Certification Date should not be earlier than EMS Personnel's Initial State's Licensure Issue Date. This is a validation message for compliance pre-testing for 2025 for NEMSIS v3.5.0.
      </sch:assert>
      </sch:rule>
   </sch:pattern>
   <!-- DIAGNOSTICS -->
