...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
            ...
            queryBinding="xslt2"
            id="EMSDataSet"
            schemaVersion="3.5.0.230317CP4_compliance_pretesting_2025">
   <sch:title>NEMSIS ISO Schematron file for EMSDataSet for Compliance Pre-testing (2025, v3.5.0)</sch:title>
   ...
   <sch:pattern id="compliance_overdose">
      ...
      <sch:rule id="compliance_overdose_rule"
         ...
         <!-- To test: On case 2023-EMS-1-Overdose_v350, remove "Hallucinations" from eExam.19 Mental Status Assessment. -->
   ...
   <sch:pattern id="compliance_cpmih_procedure">
      ...
      <sch:rule id="compliance_cpmih_procedure_rule"
         ...
         <!-- To test: On case 2023-EMS-5-CPMIH_v350, remove the "Informing doctor" procedure, or change eProcedures.03 Procedure in that instance to a different value. -->
        ...
        A procedure of "Informing doctor" should be recorded when Type of Service Requested is "Mobile Integrated Health Care Encounter". This is a validation message for compliance pre-testing for 2025 for NEMSIS v3.5.0.
      </sch:assert>
      </sch:rule>
   </sch:pattern>
   <!-- DIAGNOSTICS -->
